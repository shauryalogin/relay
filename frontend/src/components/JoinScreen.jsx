...
export default function JoinScreen({ onJoin, joinError, connected }) {
  ...
  // 3D Parallax and Cursor Tracking
  useEffect(() => {
    ...
    const handleMouseMove = (e) => {
      ...
      // Softer tilt for a cleaner feel
      const tiltX = y * -12;
      const tiltY = x * 12;
  ...
  return (
    ...
    >
      <style>{`
        ...
        /* Clean Circle Cursor (Trailing Ring) */
        .cursor-ring {
          position: fixed;
          top: 0; left: 0;
        ...
        /* Clean Circle Cursor (Center Dot) */
        .cursor-dot {
          position: fixed;
          top: 0; left: 0;
